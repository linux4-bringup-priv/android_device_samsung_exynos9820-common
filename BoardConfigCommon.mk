...
## Inherit platform specific configuration
ifeq ($(TARGET_BOARD_PLATFORM), universal9825_r)
include $(COMMON_PATH)/BoardConfig9825-r.mk
include $(COMMON_PATH)/BoardConfig9825.mk
else ifeq ($(filter beyond0lte beyond1lte beyond2lte beyondx,$(TARGET_DEVICE)),)
include $(COMMON_PATH)/BoardConfig9825.mk
